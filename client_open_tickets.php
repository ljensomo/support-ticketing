			    ...
			    <div class="content">
			      ...
			      <div class="mail-nav collapse">
			        <ul class="nav nav-pills nav-stacked ">
			          <li class="active"><a href="client_open_tickets.php"><span class="label label-primary pull-right"><?php echo $allusertickets[0]; ?></span><i class="fa fa-inbox"></i> Open</a></li>
					...
					<div class="panel panel-default" style="border-color:#272930;">
						<div class="panel-heading" style="border-color:#272930; color: white;background-color:#272930;">
							<?php 
								...
								if($row[11] == 4){
									echo 'All open tickets of ' . $row_comp[1] . '.';
								}else{ 
									echo 'All your new/open tickets.';
								}
