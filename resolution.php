				...
				<div class="col-md-12">
				    <div class="panel panel-default" style="border-color:#272930;" >
					    ...
					    <div class="panel-body">
						    <div class="header">
								<a class="btn btn-default btn-flat btn-rad" data-target="#add-resolution-modal" data-toggle="modal">
								...
								<table id="datatable" class="table table-bordered hover">
									...
									<?php
                                                ...
                                                while ($row = $res->fetch(PDO::FETCH_ASSOC)) {
                                                    ?>
									<tr class="odd gradeX">
										<td class="hidden"><?php echo $row['resolution_id']; ?>
										</td>
										...
										<td><center>
											<a id="view_res" class="btn btn-info btn-md btn-flat btn-rad">
												<i class="fa fa-search"></i> View
											</a>
											<a id="edit_res" class="btn btn-warning btn-md btn-flat btn-rad">
...
<?php include_once 'modals/resolution_modals.php'; ?>
