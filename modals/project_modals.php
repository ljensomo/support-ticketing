	...
	<div class="modal-dialog colored-header danger">
		<div class="modal-content">
			<div class="modal-header" style="background-color: #272930;border-bottom: 1px solid #272930 !important">
				...
				<h3 align="center">
				<i class="fa fa-plus" style="padding-right: 10px"></i>Add Project</h3>
			</div>
				...
				<div class="text-center">
					<form action="#" class="form-horizontal group-border" method="POST" novalidate="" parsley-validate="" style="border-radius: 0px;">
						...
						<div class="spacer text-center" style="padding-left: 30px">
							...
							<button class="btn btn-primary btn-md btn-flat btn-rad" onclick="add_project(<?php echo $cmpny_id; ?>)" style="width: 150px;" type="button">
	...
	<div class="modal-dialog colored-header danger">
		<div class="modal-content">
			<div class="modal-header" style="background-color: #272930;border-bottom: 1px solid #272930 !important">
				...
				<h3 align="center">
				<i class="fa fa-plus"></i> Add Project</h3>
			</div>
			<div class="modal-body">
				<div class="text-center">
					<form action="#" class="form-horizontal group-border" method="POST" novalidate="" parsley-validate="" style="border-radius: 0px;">
						<div class="form-group">
							<label class="col-sm-3 control-label">Project</label>
							<div class="col-sm-7">
								<select class="select2" name="sel_prjct" id="sel_prjct">
								<option value="">Select Project</option>
								<?php
								$slct_prjct = "SELECT * FROM projects";
								$res_prjct = $db->prepare($slct_prjct);
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input id="date_implement" type="date" class="form-control" >
							</div>
						</div>
						<div class="form-group" style="display: none;">
							<label class="col-sm-3 control-label">Project</label>
						...
						<div class="spacer text-center" style="padding-left: 30px">
							<button class="btn btn-primary btn-md btn-flat btn-rad" onclick="add_project(<?php echo $cmpny_id; ?>)" style="width: 100px;margin-right:180px;" type="button">
