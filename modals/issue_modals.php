<!-- NEW ISSUE -->
<div id="new_issue_type" class="modal fade" role="dialog" tabindex="-1">
	<div class="modal-dialog colored-header primary">
		<div class="modal-content">
			<div class="modal-header" style="border-bottom: 1px solid #272930 !important;background-color: #272930;">
				...
				<h3>
				<i class="fa fa-plus-circle" style="padding-right: 10px"></i>Add New Issue 
				Type</h3>
			</div>
			<div class="modal-body">
				<form action="#" class="form-horizontal" method="POST" novalidate="" parsley-validate="" style="border-radius: 0px; padding-left: 50px">
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input class="form-control" name="issue" id="issue" placeholder="Enter text..." type="text">
						</div>
					</div>
					<hr>
					<div class="spacer text-center">
						<button class="btn btn-primary btn-md" onclick="new_issue_typ()" type="button" style="margin-right:172px;">
