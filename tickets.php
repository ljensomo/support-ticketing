        ...
        <div class="content">
          ...
          <div class="mail-nav collapse">
            <ul class="nav nav-pills nav-stacked ">
              ...
              <li><a href="#"><i class="fa fa-envelope"></i> Unassgined tickets</a></li>
              <li><a href="#"><i class="fa fa-suitcase"></i> All unsolved tickets</a></li>
							...
							<table class="no-border">
								...
								<?php
									...
									<tr>
										...
										<td class="text-right"><?php echo $row['ticketstatus_id']; ?></td>
									</tr>
									  <?php
                                            }
                                            ?>
