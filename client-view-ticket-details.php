          ...
          <div class="content">
            ...
            <div class="mail-nav collapse">
              <ul class="nav nav-pills nav-stacked ">
                ...
                <li><a href="client_pending_tickets.php"><span class="label label-info pull-right"><?php echo $allinprogresstickets[0]; ?></span><i class="fa fa-spinner"></i> Pending / In Progress</a></li>
