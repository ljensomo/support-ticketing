            ...
            <div class="container-fluid" id="pcont">
                <div class="page-head">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">View User</a></li>
                    </ol>
                </div>	
                <div class="cl-mcont">
                        ...
                        <div class="col-md-12">
                            <div class="block-flat">
                                ...
                                <div class="content">
                                    ...
                                    ?>
                                    <form method="POST" action="includes/activate_user_process.php" class="form-horizontal group-border-dashed" style="border-radius: 0px;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" name="mname" id="mname" value="<?php echo $mname; ?>" type="text" readonly>                               
                                            </div>
                                        </div>
