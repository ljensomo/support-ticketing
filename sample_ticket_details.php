              ...
              <?php 
                ...
                <div class="panel panel-danger">
                  ...
                  <div class="panel-body">
                    <div class="content">
                          <p class="pull-right">
                            <strong>Date Created : <?php echo $tckt_row[4]; ?></strong>
                          </p>
                          <br>
                          <p><strong>
                                <i class="fa fa-folder"></i>&nbsp <?php echo $tckt_row[1]; ?> | 
                                <i class="fa fa-user"></i>&nbsp<small>Created by: </small> 
                                <?php echo $tckt_row[19] ." ". $tckt_row[20] ." ". $tckt_row[21]; ?>
                            </strong><br><i class="fa fa-list"></i> &nbsp <?php echo $tckt_row[13]; ?>
                            <br><?php echo $tckt_row[14] ?>
                          </p>
                    <?php 
                    ...
                    ?>
                          <p><strong>Status : 
                                <label class="label label-default"><?php echo $stts_row[1]; ?></label>
                                 | Severity : <label class="label label-info">
                                 <?php if($tckt_row[9]==""){
                                      echo "Not Set"; 
                                  }else{ 
                                      echo $svrty_row[1]; 
                                  } ?></label> | Resolution : <label class="label label-success"><?php if($tckt_row[10]==""){
                                      echo "Not Set";
                                  }else{
                                      echo $rsltion_row[1];
                                  } ?>
                              </strong>
                              <a class="btn btn-danger btn-flat pull-right" type="button" onclick="set_tckt()">
                                <i class="fa fa-gear"></i>
                                  Set Ticket Details
                              </a>
                          </p>
                      <a class="image-zoom" href="attachment/<?php echo $tckt_row[15]; ?>"><center><img src="attachment/<?php echo $tckt_row[15]; ?>" class="img-thumbnail" style="height:400px;width:1100px;" /></center></a>
                    </div>
                  </div>
                </div>
            ...
            <div class="chat-wi">
              <div class="chat-in">
                <form action="" method="post" name="sd">
                  <input type="button" value="SEND" onclick="add_cmmnt()" class="btn btn-info pull-right">
                  <div class="input">
                    ...
                    <input type="text" placeholder="Write a comment..." name="msg" id="msg">
                  </div>
