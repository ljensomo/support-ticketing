			    ...
			    <div class="content">
			      ...
			      <div class="mail-nav collapse">
			        <ul class="nav nav-pills nav-stacked ">
			          ...
			          <li class="active"><a href="client_closed_tickets.php"><span class="label label-info pull-right"><?php echo $alluserclosedtickets[0]; ?></span><i class="fa fa-lock"></i> Closed</a></li>
			        </ul>
					...
					<div class="panel panel-default" style="border-color:#272930;">
						<div class="panel-heading" style="border-color:#272930; color: white;background-color:#272930;">
							<?php 
								...
								if($row[11] == 4){
									echo 'All closed tickets of ' . $row_comp[1] . '.';
								}else{ 
									echo 'All your closed tickets.';
								}
								...
								<div class="table-responsive">
									<table id="datatable" class="table table-bordered">
										...
										<tr class="odd gradeX">
											...
											<?php } ?>
											<?php if($row[11]==4){ ?>
											<td><?php echo $row_tickets[19] . " " . $row_tickets[20] . " " . $row_tickets[21]; ?></td>
											<?php } ?>
											<td><center><?php if ($row_tickets[5] == 3) { ?>
											<label class="label label-default"><?php echo $row_tickets[17]; ?>
											</label><?php } else if ($row_tickets[5] == 7) { ?>
											<label class="label label-danger"><?php echo $row_tickets[17]; ?>
											</label><?php } ?>
											</center></td>
											<td><center>
											<a class="btn btn-sm btn-info" type="button" onclick="re_open(<?php echo $row_tickets[0]; ?>)">
											<i class="fa fa-unlock"></i>Re-Open</a>
											</center></td>
										</tr>
										<?php
	                                            }
	...
	function re_open(id){
      swal({
	    ...
	    function(){
	      $.ajax({
	        type:"POST",
	        url:"includes/reopen_tckt_process.php",
	        data:"id="+id,
	        success:function(data){
	          swal({ title:"Re-Open!", text:'The ticket was re-opened.', type:"success"},
	            function(){
