				...
				<div class="col-md-12">
					<div class="panel panel-default" style="border-color:#272930;">
						<div class="panel-heading" style="border-color:#272930; color: white;background-color:#272930;">
							All closed tickets of <?php echo $row_comp[1]; ?>.
						</div>
									...
									<table id="datatable" class="table table-bordered">
										...
										if($row[11]==4){
					                                ...
					                                $ticket_loader = "SELECT
																	...
																	JOIN users AS f
																	ON f.user_id=a.reporter_id
																	WHERE f.company_id=? AND b.before_status IN (3,7,17)";
	                                                $res_tickets = $db->prepare($ticket_loader);
										...
										<tr class="odd gradeX">
											...
											<td><center>
												<a href="client-view-ticket-details.php?tid=<?php echo $row_tickets[0]; ?>" class="btn btn-sm btn-info" type="button">
													View Ticket
												</a>
											</center></td>
										</tr>
