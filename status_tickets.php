                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="datatable">
                                    ...
                                    <tbody>
                                        ...
                                        echo  '<td>'.$data['problem_desc'].'</td>';
                                         echo   '<td class="center">None</td>';
                                          echo  '<td>'.$data['ticketstatus_id'].'</td>';
                                          echo   '<td><span class="center"></i>'.$data['date_created'].'</span></td>';
                                          echo  '<td class="center"><div class="btn-group"><button class="btn btn-default btn-xs" type="button">Actions</button>';
                                           echo '<button data-toggle="dropdown" class="btn btn-xs btn-primary dropdown-toggle" type="button">';
                                           echo  '<span class="caret"></span>';
                                           echo   '<span class="sr-only">Toggle Dropdown</span>';
                                            echo '</button>';
                                             echo   '<ul role="menu" class="dropdown-menu pull-right">';
                                                 echo   '<li><a href="#">Add Comment</a></li>';
