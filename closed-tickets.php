                                                ...
                                                <tbody>
                                                    ...
                                                    while ($row_tickets =  $res_tickets->fetch(PDO::FETCH_NUM)) {
                                                        ...
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <?php if ($row_tickets[8] == 3) { ?>
                                                                <label class="label label-success"><?php echo $row_tickets[9]; ?></label>
                                                            <?php } else if ($row_tickets[8] == 7) { ?>
                                                            ...
                                                            <td>
                                                                <center>
                                                                    <a class="btn btn-info btn-sm btn-flat btn-rad" href="view-ticket.php?tid=<?php echo $row_tickets[0]; ?>">View Details</a>
                                                                </center>        
                                                            </td>
                                                        </tr>
                                                    <?php
