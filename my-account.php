...
<title>My Account - Fortis Ticketing System</title>
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="panel panel-default" style="border-color:#272930;">
						...
						<div class="panel-body">
							<div id="settings">
							  <form class="form-horizontal" enctype="multipart/form-data" action="includes/edit-account-settings.php" method="POST">
