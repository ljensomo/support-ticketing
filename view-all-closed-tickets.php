                                            ...
                                            <table class="table table-bordered hover" id="datatable">
                                                ...
                                                <tbody>
                                                    ...
                                                    $ticket_loader = "SELECT 
                                                                        ...
                                                                        AND DATE_FORMAT(date_created,'%M %Y') = ?";
                                                    $res_tickets = $db->prepare( $ticket_loader);
                                                    $res_tickets->execute(array($date));
                                                    while ($row_tickets =  $res_tickets->fetch(PDO::FETCH_NUM)) {
                                                        ...
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td class="center">
                                                    <center>
                                                        <a href="view-ticket.php?tid=<?php echo $row_tickets[0]; ?>" class="btn btn-info btn-sm"><i class="fa fa-search"></i>View Details</a>
                                                    </center>        
                                                    </td
                                                    </tr>
                                                    <?php
