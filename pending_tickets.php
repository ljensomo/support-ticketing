        ...
        <div class="content">
          ...
          <div class="mail-nav collapse">
            <ul class="nav nav-pills nav-stacked ">
              ...
              <li class ="active"><a href="#"><span class="label label-default pull-right">3</span><i class="fa fa-file-o"></i> Pending Tickets</a></li>
    ...
    <div class="block-flat">
						...
						<div class="content">
							<table class="no-border">
								...
								<?php
                                                $sql = "SELECT * FROM ticket WHERE ticketstatus_id=2";
                                                $res = $db->prepare($sql);
                                                $res->execute();
