				...
				<div class="col-md-12">
					<div class="panel panel-default" style="border-color:#272930;">
						<div class="panel-heading" style="border-color:#272930; color: white;background-color:#272930;">
							All project/s that is assigned to you.
						</div>
									...
									<table id="datatable" class="table table-bordered hover">
										...
										<?php 
											...
											$query = "SELECT 
													...
													JOIN projects AS p
													ON cp.project_id=p.proj_id
													WHERE cp.assignee_id = ?";
										...
										<tr class="odd gradeX">
											<td class="hidden"><?php echo $projects[0]; ?></td>
											<td><strong><?php echo $projects[4]; ?></strong></td>
											<td>
												<a class="btn btn-md btn-primary btn-flat btn-rad" href="project-tickets.php?pid=<?php echo $projects[2]; ?>">View all tickets</a>
											</td>
										</tr>
