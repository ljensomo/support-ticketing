			    ...
			    <div class="content">
			      ...
			      <div class="mail-nav collapse">
			        <ul class="nav nav-pills nav-stacked ">
			          ...
			          <li class="active"><a href="client_pending_tickets.php"><span class="label label-info pull-right"><?php echo $alluserinprogresstickets[0]; ?></span><i class="fa fa-spinner"></i> Pending / In Progress</a></li>
								...
								<table id="datatable" class="table table-bordered">
									...
									<?php
										if($row[11]==4){
												...
												JOIN users AS f
												ON f.user_id=a.reporter_id
												WHERE f.company_id=? AND b.before_status IN(2,5) AND f.user_id=?";           
                                                $res_tickets = $db->prepare($ticket_loader);
									...
									<tr class="odd gradeX">
										...
										</strong><br><small><?php echo substr($row_tickets[14],0,50); ?>
										..</small></td>
										...
										<?php } ?>
										<td><center>
										<a class="btn btn-sm btn-info" href="client-ticket-details.php?tid=<?php echo $row_tickets[0]; ?>">
										View Details</a>
										</center>
										</td>
									</tr>
