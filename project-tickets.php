...
<title>Tickets - Fortis Ticketing System</title>
			  ...
			  <div class="fixed nano nscroller">
			    <div class="content">
			      ...
			      <div class="mail-nav collapse">
			        ...
			        <ul class="nav nav-pills nav-stacked ">
			          <li class="active"><a href="client-assigned-projects.php"><span class="label label1 pull-right"></span>Project/s Assigned</a></li>
			        </ul>
			        <div class="compose">
			...
			<div class="row">
				...
				<div class="panel panel-default" style="border-color:#272930;">
					<div class="panel-heading" style="border-color:#272930; color: white;background-color: #272930;">
						All your tickets created in the project.
					</div>
							...
							<div class="table-responsive">
								<table id="datatable" class="table table-bordered hover">
									...
									<?php
		                                ...
		                                $res_tickets->execute(array($row[0],$pid));
									...
									<tr class="odd gradeX">
										...
										<td><strong><?php echo $row_tickets[13]; ?>
										</strong><br><small><?php echo substr($row_tickets[14],0,30); ?>
										..</small></td>
										<td><?php echo $row_tickets[2]; ?></td>
										<td><?php echo $row_tickets[4]; ?></td>
										<?php if($row[11]==4){ ?>
										<td><?php echo $row_tickets[19] . " " . $row_tickets[21]; ?></td>
										<?php } ?>
										<td><center><?php if ($row_tickets[5] == 1) { ?>
										<label class="label label-default"><?php echo $row_tickets[17]; ?>
										</label><?php } else if ($row_tickets[5] == 5) { ?>
										<label class="label label-info"><?php echo $row_tickets[17]; ?>
										</label><?php } else if ($row_tickets[5] == 3) { ?>
										<label class="label label-success"><?php echo $row_tickets[17]; ?>
										</label><?php } else if ($row_tickets[5] == 2) { ?>
										<label class="label label-danger"><?php echo $row_tickets[17]; ?>
										</label><?php } else if ($row_tickets[5] == 4) { ?>
										<label class="label label-default"><?php echo $row_tickets[17]; ?>
										</label><?php } else if ($row_tickets[5] == 6) { ?>
										<label class="label label-danger"><?php echo $row_tickets[17]; ?></label><?php } else if ($row_tickets[5] == 7) { ?>
										<label class="label label-danger"><?php echo $row_tickets[17]; ?></label><?php } ?></center></td>
										<td><center>
										<a class="btn btn-sm btn-info" href="client-view-ticket-details.php?tid=<?php echo $row_tickets[0]; ?>">
										View Details</a>
										</center></td>
									</tr>
									<?php
...
<div id="hide_tckt" class="modal fade" role="dialog" tabindex="-1">
	<div class="modal-dialog colored-header danger">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h3 align="left">
				<i class="fa fa-warning" style="padding-right: 10px"></i>Suspend Ticket</h3>
			</div>
			<div class="modal-body">
				<form action="includes/edit_user_process.php" class="form-horizontal" method="POST" novalidate="" parsley-validate="" style="border-radius: 0px; padding-left: 50px">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<textarea class="form-control" id="remrks" placeholder="Remarks" rows=5></textarea>
						</div>
					</div>
					
					<div class="spacer text-center">
						<button class="btn btn-danger btn-lg" style="width: 20%" type="button">
