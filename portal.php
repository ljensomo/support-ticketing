                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-12">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="spacer spacer-bottom-xs">
                                                <a href="createticket.php"><input class="btn btn-primary btn-lg" type="submit" value="Create Ticket" /></a>
                                                <a href="view_tickets.php"><input class="btn btn-danger btn-lg" type="submit" value="View Ticket" /></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
