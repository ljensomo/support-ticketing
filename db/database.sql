...
MySQL - 5.1.41 : Database - ticketing
*********************************************************************
*/
...
CREATE TABLE `ticket` (
  ...
  `problem_desc` varchar(255) NOT NULL DEFAULT '',
...
insert  into `ticket`(`ID`,`CompanyName`,`Reporter`,`email_add`,`cnum`,`problem_desc`,`issuetype_id`,`severity_id`,`ticketstatus_id`,`transactionID`,`Attachment`,`date_created`) values (1,'Gicha\'s Night Club','Nigel Kim Gocila','nigel@gmail.com','09090909','C',1,'2','5','#45456',NULL,'2010-31-10');
...
insert  into `users`(`userId`,`username`,`password`,`fname`,`mname`,`lname`,`userlevel_id`) values (1,'jason','pogi','Jason','L','Gicha',1);
