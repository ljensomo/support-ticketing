            ...
            <div class="container-fluid" id="pcont">
                ...
                <div class="cl-mcont">
                    ...
                    <div class="block-flat">
                        ...
                        <div class="content">
                            <form method="POST" action="includes/add_client_process.php" class="form-horizontal group-border-dashed" style="border-radius: 0px;" parsley-validate novalidate>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" placeholder="Number" name="contact_no" type="text">                               
