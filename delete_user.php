                        ...
                        <div class="col-md-12">
                            <div class="block-flat">
                                ...
                                <div class="content">
                                    ...
                                    ?>
                                    <form method="POST" action="includes/delete_user_process.php" class="form-horizontal group-border-dashed" style="border-radius: 0px;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" name="mname" id="mname" type="text" value="<?php echo $mname; ?>" readonly>                               
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a class="btn btn-danger" href="includes/delete_user_process.php?id=<?php echo $id; ?>">Yes</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
